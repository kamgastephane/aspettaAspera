...
/**
 * relay between the {@link ProtocolHandler} and the {@link aspettaaspera.downloader.DownloaderRunnable}
...
public interface ProgressListener {
    ...
    /**
     * @param buffer pass a chunk of bytes to the {@link aspettaaspera.downloader.DownloaderRunnable} to be save on the disk
